...
@section('content')
<style>
    a.dk-stat-card { text-decoration:none; cursor:pointer; transition:all 0.2s; }
    a.dk-stat-card:hover { transform:translateY(-2px); box-shadow:0 8px 25px rgba(0,0,0,0.3); border-color:#4f46e5; }
</style>
...
<div class="dk-grid-3" style="display:grid; grid-template-columns:repeat(3,1fr); gap:24px; margin-bottom:32px;">
    <a href="{{ route('admin.members') }}" class="dk-stat-card">
    ...
    <a href="{{ route('admin.products.index') }}" class="dk-stat-card">
    ...
    <a href="{{ route('admin.orders') }}" class="dk-stat-card">
    ...
    <a href="{{ route('admin.commissions') }}" class="dk-stat-card">
    ...
    <a href="{{ route('admin.withdrawals') }}" class="dk-stat-card">
