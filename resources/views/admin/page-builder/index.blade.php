...
<form method="GET" action="{{ route('admin.page-builder.index') }}" class="mb-6" style="max-width:420px;">
        ...
        <div class="dk-card" style="overflow:hidden; display:flex; flex-direction:column;">
            ...
            <div style="padding:16px; display:flex; flex-direction:column; gap:12px; flex:1;">
                ...
                <div style="display:flex; gap:8px; margin-top:auto;">
                    <a href="{{ route('admin.page-builder.edit', $product) }}" class="dk-btn dk-btn-primary" style="flex:1; justify-content:center;">
