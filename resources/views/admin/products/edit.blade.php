    ...
    <div class="dk-card" style="padding:24px;">
        <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                ...
                <div id="compare-at-price-section" style="{{ old('product_type', $product->product_type) === 'free' ? 'display:none;' : '' }}">
                    ...
                    <input type="number" name="compare_at_price" id="compare_at_price" value="{{ old('compare_at_price', $product->compare_at_price) }}" placeholder="Kosongkan jika tidak dipakai" class="w-full dk-input">
                ...
                @php
                    $existingPackages = old('packages', $product->packages->map(function ($p) {
                        return [
                            'id' => $p->id,
                            'label' => $p->label,
                ...
                @endphp
                @include('admin.products._packages-section', ['existingPackages' => $existingPackages, 'hasPackages' => $hasPackages, 'productType' => old('product_type', $product->product_type ?? 'digital')])

                <div id="license-duration-section" style="{{ old('product_type', $product->product_type) === 'software' && ! $hasPackages ? '' : 'display:none;' }}">
                ...
                <div id="max-devices-section" style="{{ old('product_type', $product->product_type) === 'software' ? '' : 'display:none;' }}">
                    <label for="max_devices" class="dk-label">Batas Device per Lisensi</label>
                    <input type="number" name="max_devices" id="max_devices" min="1" max="100" value="{{ old('max_devices', $product->max_devices ?? 1) }}" class="w-full dk-input">
