...
<div class="max-w-3xl mb-8">
    <div class="dk-card" style="padding:24px;">
        ...
        <form method="POST" action="{{ route('admin.products.landing-page.update', $product) }}" enctype="multipart/form-data">
            ...
            {{-- Custom HTML — textarea untuk kode HTML murni --}}
            ...
            <div style="border-bottom:1px solid #1e2b3d pb-6 pt-6">
                ...
                <p class="text-xs dk-text-muted mb-1">Paste <strong>satu halaman HTML utuh</strong> (&lt;html&gt;..&lt;/html&gt;). Landing page akan sepenuhnya diganti dengan HTML ini — bukan sekadar section tambahan. <strong style="color:#fde047">Cocok untuk full Tailwind/landing page buatan sendiri.</strong></p>
                ...
                <div id="full_html_block" style="display:{{ old('use_full_html', $lp->use_full_html ?? false) ? 'block' : 'none' }}">
                    ...
                    <p class="text-[11px] dk-text-muted mt-1">CDN <strong>script, link, meta, title</strong> DIPERTAHANKAN. <strong style="color:#fca5a5">&lt;script&gt; inline dan event handler</strong> (onclick,dll) dihapus untuk keamanan. Pastikan landing page sistem sudah di-publish.</p>
                </div>
            </div>
