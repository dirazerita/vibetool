        ...
        <div class="dk-table">
            ...
            <div class="p-4">
                ...
                <div class="flex flex-wrap gap-1.5 pt-2 dk-divider">
                    ...
                    <a href="{{ route('dashboard.products.landing-page', $product) }}" class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded text-xs font-medium transition-colors" style="color:#a78bfa">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        Landing Page
                    </a>
                    <a href="{{ route('dashboard.products.video-tutorials', $product) }}" class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded text-xs font-medium transition-colors" style="color:#34d399">
                    ...
                    @endif
                    <a href="{{ route('product.show', $product->slug) }}" target="_blank" class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded text-xs font-medium transition-colors" style="color:#fbbf24">
