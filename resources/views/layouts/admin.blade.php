    ...
    <div class="dk-shell">
        ...
        <aside class="dk-sidebar" :class="sidebarOpen ? 'dk-open' : ''">
            ...
            <nav style="padding:0 12px; flex:1; display:flex; flex-direction:column; gap:4px;">
                ...
                <a href="{{ route('admin.page-builder.index') }}" class="dk-sidebar-link {{ request()->routeIs('admin.page-builder.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.promo-templates.index') }}" class="dk-sidebar-link {{ request()->routeIs('admin.promo-templates*') ? 'active' : '' }}" style="position:relative;">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                    Template Promo
                    @if(($adminPendingPromoTemplates ?? 0) > 0)
                        <span style="margin-left:auto; background:#ef4444; color:#fff; font-size:11px; font-weight:700; padding:1px 8px; border-radius:9999px; min-width:20px; text-align:center;">{{ $adminPendingPromoTemplates }}</span>
                    @endif
                </a>
