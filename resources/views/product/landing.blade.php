            ...
            <div style="position: relative; height: 500px;">
                ...
                <div style="position: absolute; inset: 0; display: flex; align-items: center; justify-content: center;">
                    <div style="text-align: center; padding: 0 16px; max-width: 56rem;">
                        <h1  style="font-family: '{{ $landingPage->hero_title_font ?? 'Poppins' }}', sans-serif; font-size: {{ $landingPage->hero_title_size ?? '48px' }}; color: {{ $landingPage->hero_title_color ?? '#ffffff' }};">{{ $landingPage->hero_title }}</h1>
